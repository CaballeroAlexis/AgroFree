...
@Component({
  selector: 'app-menu5-registro-mantenimiento-instalacion-cuarentena',
  templateUrl: './menu5-registro-mantenimiento-instalacion-cuarentena.component.html',
  styleUrls: ['./menu5-registro-mantenimiento-instalacion-cuarentena.component.css']
})
export class Menu5RegistroMantenimientoInstalacionCuarentenaComponent{

  data_table:any;
  table_name= "m5_registro_mantenimiento_instalacion_cuarentena";
