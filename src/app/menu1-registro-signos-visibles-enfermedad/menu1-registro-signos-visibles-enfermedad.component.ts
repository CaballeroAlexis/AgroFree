...
@Component({
  selector: 'app-menu1-registro-signos-visibles-enfermedad',
  templateUrl: './menu1-registro-signos-visibles-enfermedad.component.html',
  styleUrls: ['./menu1-registro-signos-visibles-enfermedad.component.css']
})
export class Menu1RegistroSignosVisiblesEnfermedadComponent  {

  data_table:any;
  table_name= "m1_registro_signos_visibles_enfermedad";
