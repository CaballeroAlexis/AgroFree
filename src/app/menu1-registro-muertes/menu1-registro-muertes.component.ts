...
@Component({
  selector: 'app-menu1-registro-muertes',
  templateUrl: './menu1-registro-muertes.component.html',
  styleUrls: ['./menu1-registro-muertes.component.css']
})
export class Menu1RegistroMuertesComponent {

  data_table:any;
  table_name= "m1_registro_muertes";
