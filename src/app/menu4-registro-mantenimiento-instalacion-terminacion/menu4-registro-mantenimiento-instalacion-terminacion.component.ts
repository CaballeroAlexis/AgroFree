...
@Component({
  selector: 'app-menu4-registro-mantenimiento-instalacion-terminacion',
  templateUrl: './menu4-registro-mantenimiento-instalacion-terminacion.component.html',
  styleUrls: ['./menu4-registro-mantenimiento-instalacion-terminacion.component.css']
})
export class Menu4RegistroMantenimientoInstalacionTerminacionComponent  {

  data_table:any;
  table_name= "m4_registro_mantenimiento_instalacion_avicola_terminacion";
