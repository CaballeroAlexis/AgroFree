...
@Component({
  selector: 'app-menu2-registro-aplicacion-productos-veterinarios',
  templateUrl: './menu2-registro-aplicacion-productos-veterinarios.component.html',
  styleUrls: ['./menu2-registro-aplicacion-productos-veterinarios.component.css']
})
export class Menu2RegistroAplicacionProductosVeterinariosComponent {

  data_table:any;
  table_name= "m2_registro_aplicacion_productos_veterinarios";
