...
@Component({
  selector: 'app-menu12-registro-toma-muestra-envio-agua-microbiologico',
  templateUrl: './menu12-registro-toma-muestra-envio-agua-microbiologico.component.html',
  styleUrls: ['./menu12-registro-toma-muestra-envio-agua-microbiologico.component.css']
})
export class Menu12RegistroTomaMuestraEnvioAguaMicrobiologicoComponent  {
  data_table:any;
  table_name= "m12_registro_toma_muestra_envio_agua_microbiologico";
