...
@Component({
  selector: 'app-registro-alta-baja-reproductores',
  templateUrl: './registro-alta-baja-reproductores.component.html',
  styleUrls: ['./registro-alta-baja-reproductores.component.css']
})
export class RegistroAltaBajaReproductoresComponent {
  data_table:any;
